...
do
   ...
   do
      ...
      python3 -m flexgen.flex_opt --model facebook/opt-6.7b --path __DUMMY__ --gpu-batch-size ${BATCH_SIZE} --prompt-len ${LIN} --percent 0 100 0 100 0 100 --cpu-cache-compute
   done
done
