...
class TorchDevice:
    ...
    def mha_gen(self, inputs, attention_mask, w_q, b_q, w_k, b_k, w_v, b_v,
        ...
        # print("Device of 'value':", value.device)
        # print("Device of 'w_out.data':", w_out.data.device)
        # print("Device of 'bias':", b_out.data.device)
        # print(f"value dtype: {value.dtype}")
        # print(f"w_out dtype: {w_out.data.dtype}")
        # print(f"bias dtype: {b_out.data.dtype}")
        value = F.linear(value, w_out.data, bias=b_out.data)
